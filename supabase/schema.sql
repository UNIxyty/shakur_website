-- SHAKUR — v2 schema: projects (i18n/media JSON), services, meetings,
-- availability, site_settings.
...
--
-- Upgrading a deployed v1 database? Use supabase/migrate-v2.sql instead — this
-- file assumes the v2 projects column set.
